(() => {
    ...
    waitForElement('#mainmenu', () => {
        ...
        const MENU_IMAGES = {
            ...
            'plissgordijnen': `
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    <path d="M42.5977 11.0798V7.50781" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.1094 8.99581L42.5974 7.50781L44.0814 8.99581" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M5.4043 38.4839V42.0519" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M6.89192 40.5679L5.40392 42.0519L3.91992 40.5679" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M38.6395 4.0918H9.35547V43.9118H38.6395V4.0918Z" fill="white" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M35.8606 7.20801H12.1406V41.296H35.8606V7.20801Z" fill="white" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.631 30.7354H21.619H21.199H5.383L4.375 32.5354L5.383 34.3314H21.199H21.619H42.631L43.639 32.5354L42.631 30.7354Z" fill="#595859" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.631 23.5435H21.619H21.199H5.383L4.375 25.3435L5.383 27.1395H21.199H21.619H42.631L43.639 25.3435L42.631 23.5435Z" fill="#595859" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.631 27.1396H21.619H21.199H5.383L4.375 28.9396L5.383 30.7356H21.199H21.619H42.631L43.639 28.9396L42.631 27.1396Z" fill="#595859" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.631 16.3516H21.619H21.199H5.383L4.375 18.1516L5.383 19.9476H21.199H21.619H42.631L43.639 18.1516L42.631 16.3516Z" fill="#595859" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.631 19.9478H21.619H21.199H5.383L4.375 21.7478L5.383 23.5438H21.199H21.619H42.631L43.639 21.7478L42.631 19.9478Z" fill="#595859" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M4.375 18.1514H43.639" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M4.375 21.7476H43.639" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M4.375 25.3438H43.147" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M4.375 28.9395H43.639" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M4.35938 32.5356H43.6234" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M43.535 12.8276H4.45898V15.9676H43.535V12.8276Z" fill="white" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M43.535 33.5239H4.45898V36.6639H43.535V33.5239Z" fill="white" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.5977 11.0798V7.50781" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.1094 8.99581L42.5974 7.50781L44.0814 8.99581" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M5.4043 38.4839V42.0519" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M6.89192 40.5679L5.40392 42.0519L3.91992 40.5679" stroke="#F39719" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            'duo-rolgordijnen': `
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    <path d="M38.6395 4.104H9.35547V43.924H38.6395V4.104Z" fill="white" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M35.8606 9.05615H12.1406V41.3082H35.8606V9.05615Z" fill="white" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.6966 4.104H6.30859V25.18H41.6966V4.104Z" fill="#F29000" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M19.7656 36.2801L26.5896 29.4561" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M23.7031 36.5802L25.9151 34.3682" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.6966 4.07617H6.30859V25.1522H41.6966V4.07617Z" fill="white" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.6966 5H6.30859V25.212H41.6966V5Z" fill="#595859" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.6966 18.1279H6.30859V21.7919H41.6966V18.1279Z" fill="white" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M41.6966 10.7959H6.30859V14.4599H41.6966V10.7959Z" fill="white" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M43.5369 4.104H4.46094V7.244H43.5369V4.104Z" fill="white" stroke="#1C1C16" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>`,
            'gordijnen': `
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
            ...
            'vouwgordijnen': `
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    ...
                    <path d="M24.0009 22.3721H4.95694L4.46094 24.4241H24.0009H43.5409L43.0449 22.3721H24.0009Z" fill="#585858" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M37.2539 7.23193V24.4239" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M6.62891 7.23193V36.1999" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M12.0879 7.23193V36.1999" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M9.35547 7.23193V36.1999" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M7.79284 34.916H5.46484V41.116H7.79284V34.916Z" fill="#F29000" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M13.3046 34.916H10.9766V41.116H13.3046V34.916Z" fill="#F29000" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M10.5253 27.4121H8.19727V33.6121H10.5253V27.4121Z" fill="#F29000" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>`,
            'lamellen': `
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    <path d="M38.6414 3.42822H9.35742V43.2482H38.6414V3.42822Z" fill="white" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M35.6536 6.56836V40.6324H12.3496V6.56836" fill="white"/>
                    <path d="M35.6536 6.56836V40.6324H12.3496V6.56836" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M10.2617 44.5724L5.17773 43.1924V6.56836H10.2617V44.5724Z" fill="#585858" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M16.7735 44.5724L11.6895 43.1924V6.56836H16.7735V44.5724Z" fill="#585858" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M36.3145 44.5724L31.2305 43.1924V6.56836H36.3145V44.5724Z" fill="#585858" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M42.8262 44.5724L37.7422 43.1924V6.56836H42.8262V44.5724Z" fill="#585858" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M43.5369 3.42822H4.46094V6.56822H43.5369V3.42822Z" fill="white" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M19.7656 36.3439L26.5896 29.5239" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M23.7031 36.6441L25.9151 34.4321" stroke="#1C1C16" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>`,
        ...
        function buildMegaMenu() {
            ...
            if (!document.querySelector('.gmd-mega-menu')) {
                ...
                innerWrapper.className = 'gmd-mega-inner';
