(() => {
    ...
    `;
        ...
        const loader = panel.querySelector('.gmd-loader');
        ...
        function handleIframeLoad() {
            ...
            .gmd-iframe-login:has(#mobileLoginDrawer.visible) {
                display: block;
            }
        ...
        `;
            ...
            if (checkoutActions && forgotPassword && forgotPassword.previousElementSibling !== checkoutActions) {
            ...
            loginForm.forEach((form) => {
                ...
                // Prevent duplicate listener after iframe reload
                if (form.dataset.gmdLoginBound === 'true') {
                    return;
                }

                form.dataset.gmdLoginBound = 'true';
            ...
            doc.querySelectorAll('a[href="/wachtwoord-vergeten"]').forEach((link) => {
                ...
                if (link.dataset.gmdForgotBound === 'true') {
                    return;
                }

                link.dataset.gmdForgotBound = 'true';
        ...
        window.addEventListener('pageshow', (event) => {
            ...
            console.log(
                '[gmd-47] Returned via browser back/forward'
            );
